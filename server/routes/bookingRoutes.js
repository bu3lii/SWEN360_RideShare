...
router.patch('/:id/accept', validateMongoId('id'), bookingController.acceptBooking);
router.patch('/:id/reject', validateMongoId('id'), bookingController.rejectBooking);
router.patch('/:id/pickup', validateMongoId('id'), bookingController.markPickedUp);
router.patch('/:id/mark-paid', validateMongoId('id'), bookingController.markPaid);
